...
const services = [
  {
    ...
    description: 'We fix technical issues, improve your on-page SEO, and optimize for local search results.',
    benefit: 'So you can get more local clients without learning SEO yourself.',
  },
  {
    icon: Smartphone,
    title: 'Website Redesign & Performance Optimization',
    description: 'Refresh outdated sites with modern design, faster loading, and better user experience.',
    benefit: 'So your site impresses visitors and converts them into customers.',
  },
  {
    icon: Share2,
    title: 'Social Media Management & Content Support',
    description: 'Keep your business active and visible across social platforms with consistent, engaging content.',
    benefit: 'So you can build trust and attract more clients.',
  },
  {
    icon: Move,
    title: 'Website Migration & Replatforming',
    description: 'Safely move websites between platforms, preserving SEO rankings and improving performance.',
    benefit: 'So you can upgrade without losing rankings.',
  },
  {
    icon: Plus,
    title: 'New Features & Integrations',
    description: 'Add online booking, forms, analytics, payment systems, and custom functionality.',
    benefit: 'So you can offer more without hassle.',
  },
  {
    icon: Shield,
    title: 'Ongoing Care & Support',
    description: 'Monthly support, security updates, backups, monitoring, and technical assistance.',
...
const animationSequence = ['topLeft', 'topRight', 'middleLeft', 'middleRight', 'bottomLeft', 'bottomRight']

export default function Services() {
  return (
    <section
      id="services"
      className="relative overflow-hidden bg-linear-to-t from-gray-50 via-white to-gray-50 "
    >
    ...
    <motion.div 
      ...
      <motion.div
        className="absolute top-32 left-8 z-20 pointer-events-none"
      ...
      >
        <motion.div
          ...
          className="relative w-40 h-40 md:w-48 md:h-48 p-6 backdrop-blur-xl bg-white/20 border border-white/30 shadow-2xl"
          style={{
      ...
      >
        <motion.div
          animate={{ 
            y: [0, -25, 0],
            rotate: [15, 18, 15],
            borderRadius: ["40% 60% 70% 30%/60% 40% 60% 40%", "70% 30% 40% 60%/40% 70% 30% 60%", "40% 60% 70% 30%/60% 40% 60% 40%"]
          }}
          transition={{ 
            duration: 5, 
            repeat: Infinity, 
          ...
          className="relative w-44 h-44 md:w-52 md:h-52 p-6 backdrop-blur-xl bg-white/20 border border-white/30 shadow-2xl"
          style={{
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4 script-font" style={{ color: 'rgb(138, 178, 242)' }}>
            Our Services
          </h2>
          <style>{`
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            const animationType = animationSequence[index]
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <Icon 
                      className="w-7 h-7 text-gray-900 transition-all duration-300"
                    />
                  </motion.div>
                  ...
                  >
                    <div 
                      className="w-1 h-1 rounded-full mt-2 flex-shrink-0 bg-gray-900"
                    ></div>
                    <p 
                      className="font-medium italic text-gray-900"
                    >
                      {service.benefit}
                    </p>
                  </motion.div>
                  ...
                  <motion.div 
                    ...
                    style={{
                      background: 'radial-gradient(circle at top right, rgba(229, 231, 235, 0.3), transparent 70%)'
                    }}
                  ></motion.div>
