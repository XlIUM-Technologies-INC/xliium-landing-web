...
export default function Hero() {
  ...
  const phrases = ["go Viral", "grow Online", "get Found", "dominate Local SEO"];
  ...
  return (
   ...
   <Image src="/background@2x.png"  width={100} height={100} alt='Image of hills' className=' absolute w-full mb-20  h-full'/>
        {/* Animated Background */}
        <motion.div
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 relative z-10 w-full">
          ...
          >
            ...
            >
              ...
              We help your business dominate local search and reach more customers.
            </motion.p>
...
>
  ...
  <motion.div
    ...
    style={{
      ...
      boxShadow: '0 0 0 0.5px rgba(255,255,255,0.1), 0 50px 100px -20px rgba(0,0,0,0.6)'
    }}
    whileHover={{
      scale: 1.02,
      boxShadow: "0 0 0 0.5px rgba(255,255,255,0.1), 0 60px 120px -20px rgba(0,0,0,0.7)",
    }}
  >
    <Image src="/wallpaper@2x.b7df867c.png" width={100} height={100} className="absolute w-full h-full object-cover" alt="wallpaper"/> 
    
    {/* macOS Menu Bar */}
    <div className="h-7 bg-black/40 backdrop-blur-xl flex items-center justify-between px-4 text-white text-xs relative z-20"
         style={{
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-2">
          <img src="safari-icon (1).png" alt="Safari" className="w-4 h-4" />
      ...
      <div className="flex items-center gap-3">
        {/* Battery Icon */}
        <svg className="w-6 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          <rect x="2" y="6" width="18" height="12" rx="2" ry="2"/>
          <rect x="5" y="9" width="12" height="6" fill="currentColor"/>
          <path d="M20 10v4"/>
        </svg>
    ...
    {/* Window Content */}
    <div className="p-8 relative z-10 overflow-y-auto" style={{ maxHeight: 'calc(550px - 76px)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="bg-gradient-to-b from-gray-800/95 to-gray-800/80 px-3 py-2 border-b border-white/5 flex items-center gap-2">
              ...
              <div className="text-white/70 text-xs font-semibold ml-2">Google Search Console</div>
            </div>
          ...
          >
            ...
            <div className="bg-gradient-to-b from-gray-800/95 to-gray-800/80 px-3 py-2 border-b border-white/5 flex items-center gap-2">
              ...
              <div className="text-white/70 text-xs font-semibold ml-2">Google Analytics - Real-time</div>
            </div>
            <div className="p-4 bg-white">
              <img 
    ...
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20">
      ...
      >
        ...
        >
          <img src="launchpad-icon.png" alt="Launchpad" className="w-full h-full object-cover" />
        </motion.div>
        ...
        <motion.div 
          ...
          transition={{ type: "spring", stiffness: 400 }}
        >
          <img src="safari-icon (1).png" alt="Safari" className="w-full h-full object-cover" />
        </motion.div>
        ...
        <motion.div 
          ...
          style={{
            background: 'radial-gradient(circle at 30% 30%, rgba(255,255,255,0.3) 0%, transparent 70%), linear-gradient(135deg, rgba(255,255,255,0.2) 0%, rgba(255,255,255,0.05) 100%)',
            border: '1px solid rgba(255,255,255,0.25)'
          }}
          whileHover={{ scale: 1.3, y: -10 }}
          transition={{ type: "spring", stiffness: 400 }}
        >
          <img src="trash-icon.png" alt="Trash" className="w-10 h-10 object-contain" />
        </motion.div>
      </motion.div>
    </div>
  </motion.div>
